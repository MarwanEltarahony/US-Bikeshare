    ...
    while True:
        ...
        try:
            if input_read in ['chicago','new york city','washington'] and input_type == 1:
                ...
                if input_type == 1:
                    print("oops, please choose: chicago new york city or washington")
                if input_type == 2:
                    print("oops, please choose: january, february, march, april, may, june or all")
                if input_type == 3:
                    print("oops, please choose: sunday, ... friday, saturday or all")
        except ValueError:
